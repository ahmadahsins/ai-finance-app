...
import 'package:toastification/toastification.dart'; // IMPORT INI
...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
  ...
  // FUNGSI BARU: Menampilkan Toast Cantik di Atas (Pengganti SnackBar)
  void _showTopToast(String message, {bool isError = false}) {
    toastification.show(
      ...
      alignment: Alignment.topCenter, // INI KUNCINYA (Pasti di atas)
      ...
      animationBuilder: (context, animation, alignment, child) {
        return SlideTransition(
          position: Tween<Offset>(
            begin: const Offset(0, -1), // Dari luar layar atas
  ...
  Widget build(BuildContext context) {
    ...
    // LISTENER YANG LEBIH SIMPEL & STABIL
    ref.listen<AsyncValue<void>>(transactionControllerProvider, (
      ...
      next.whenOrNull(
        data: (_) async {
          ...
          // 2. Tampilkan Toast di Atas (Tidak butuh delay lama, tidak butuh margin)
          // Karena ini Overlay, dia akan muncul di atas layar Home dengan mulus
